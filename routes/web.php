...
Route::get('/predictions/data', [PredictionController::class, 'getPredictions']);

Route::get('predict-peak-times', [PredictionController::class, 'sendOrdersToFlask'])->name('predict.peak.times');
